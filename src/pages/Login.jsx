...
const Login = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            mostrarMensaje('error', 'Error al iniciar sesión. Por favor, verifica tus credenciales.');
        }
    };
    ...
    return (
        ...
        <div className="dark:bg-gray-800 mt-24 overflow-hidden flex items-center justify-center">
            <div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
                ...
                <form className="p-12 md:p-24" onSubmit={handleSubmit}>
                    ...
                    <button className="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded">Iniciar Sesión</button>
                </form>
            </div>
        </div>
        </>
